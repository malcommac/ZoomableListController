...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-ZoomableListController_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'CircularScrollView.framework'
  install_framework 'ZoomableListController.framework'
fi
